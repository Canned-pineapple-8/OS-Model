...
class InterruptHandler:
    def __init__(self, cpus_ptr: List[CPU], ios_ptr: List[IOController],
                 scheduler_ptr: Scheduler, dispatcher_ptr: Dispatcher, proc_table: Dict[int, Process],
        ...
        for interrupt in self.interrupts_raised:
            ...
            match interrupt.type:
                ...
                case InterruptType.PROCESS_IO_END:
                    self.dispatcher.change_process_state(process_pid, ProcessState.IO_END)
